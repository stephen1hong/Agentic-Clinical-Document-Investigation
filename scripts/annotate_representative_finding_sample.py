...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description=("Annotate the representative finding sample with evidence-aware context.")
    )
...
def main() -> int:
    """Run representative-sample annotation."""

    args = parse_args()

    root = project_root()

    sample_dir = root / "data" / "evaluation" / "representative_sample"
    ...
    print()
    print("=" * 72)
    print("REPRESENTATIVE FINDING ANNOTATION")
    print("=" * 72)
