...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description=(
            "Generate a reproducible held-out sample of post-refinement investigation findings."
        )
    )
...
def main() -> int:
    """Generate the post-refinement held-out sample."""
    ...
    output_dir = project_root / "data" / "evaluation" / "post_refinement_sample"
    ...
    print()
    print("=" * 72)
    print("POST-REFINEMENT HELD-OUT FINDING SAMPLE")
    print("=" * 72)
