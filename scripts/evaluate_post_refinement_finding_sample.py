...
MANIFEST_PATH = (
    PROJECT_ROOT / "data" / "evaluation" / "post_refinement_sample" / "finding_sample_manifest.json"
)
...
ANNOTATIONS_PATH = (
    ...
    / "data"
    / "evaluation"
    / "post_refinement_sample"
    / "finding_sample_annotations.json"
)

OUTPUT_PATH = (
    PROJECT_ROOT / "data" / "evaluation" / "post_refinement_sample" / "finding_sample_metrics.json"
)
